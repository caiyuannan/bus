...
public class CnmCooperativeBean
{
	...
	private String cooperativeX;
	private String cooperativeY;
	private String cooperativeCoordinate;
	private String cooperativeArea;
	private int stateId;
	private String stateName;

	public CnmCooperativeBean(int cooperativeId, String cooperativeName, String cooperativeType, String cooperativeX, String cooperativeY, String cooperativeCoordinate, String cooperativeArea, int stateId, String stateName)
	{
	...
	public String getCooperativeX()
	{
		return cooperativeX;
	}

	public void setCooperativeX(String cooperativeX)
	{
		this.cooperativeX = cooperativeX;
	}

	public String getCooperativeY()
	{
		return cooperativeY;
	}

	public void setCooperativeY(String cooperativeY)
	{
		this.cooperativeY = cooperativeY;
	}
