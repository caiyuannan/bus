...
import com.bus.dao.CnmCooperativeMapper;
...
//	CnmCooperativeBean总条数
	...
	//	 查询广告状态advertisement
	public List<CnmAdvertisementBean> getfindCooperativeTypeInf(CnmCooperativeBean cnmCooperativeBean){
		List<CnmAdvertisementBean> CnmAdvertisementBeanList=cnmCooperativeMapper.findCooperativeTypeInf(cnmCooperativeBean.getCooperativeId());
		return CnmAdvertisementBeanList;
	 }
