...
import com.bus.dao.CnmNewsBulletinMapper;
...
//	CnmNewsBulletinBean总条数
	...
	//	   查询新闻表信息
	public List<CnmNewsBulletinBean> getfindNewsBulletinInf(){
		List<CnmNewsBulletinBean> tableList=cnmNewsBulletinMapper.findNewsBulletinInf();
		return tableList;
	}
}
