...
<div >
	...
	<label class="layui-form-label" style="margin-left: 6%">合作商地区:</label>
...
<script >
	...
	layui.use(['table','layer','form','laypage','element'], function(){
			...
			if(obj.event === 'del') {
				...
				layer.open({
					...
					success: function(layero, index){
						$("#upcooperativeName").val(data['cooperativeName']);
						$("#upcooperativeTypeSelect").val(data['cooperativeType']);
						$("#upcooperativeX").val(data['cooperativeX']);
						$("#upcooperativeY").val(data['cooperativeY']);
						$("#upcooperativeArea").val(data['cooperativeArea']);
		...
		form.on('select', function(data){
			...
			$("#upcooperativeTypeSelect").val(data.value);
...
<script>
	...
	function updateMethod() {
		...
		var upcooperativeTypeSelect = $("#upcooperativeTypeSelect").val();
		...
		var ob={cooperativeName:upcooperativeName,cooperativeType:upcooperativeTypeSelect,cooperativeX:upcooperativeX,cooperativeY:upcooperativeY,cooperativeArea:upcooperativeArea,cooperativeId:upcooperativeId};
...
<%--		合作商类型:<input type="text" name="upcooperativeType" id="upcooperativeType"><br>--%>
		...
		合作商地区:<input type="text" name="upcooperativeArea" id="upcooperativeArea"><br>
			<label>合作商类型:</label>
				<select id="upcooperativeTypeSelect" name="upcooperativeTypeSelect"  style="margin-left: 3%;">
					<c:if test="${null != requestScope.roleSelect}">
						<c:forEach items="${requestScope.roleSelect}" begin="0" step="1" var="i">
							<option  value=${i.cooperativeType}>${i.cooperativeType}</option>
						</c:forEach>
